...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.flag'
        db.alter_column('budgetelem_region', 'flag', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Region.econokr'
        db.alter_column('budgetelem_region', 'econokr_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budgetelem.EconOkr'], null=True))

        # Changing field 'Region.fedokr'
        db.alter_column('budgetelem_region', 'fedokr_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budgetelem.FedOkr'], null=True))

    def backwards(self, orm):

        # Changing field 'Region.flag'
        db.alter_column('budgetelem_region', 'flag', self.gf('django.db.models.fields.CharField')(default=0, max_length=10))

        # Changing field 'Region.econokr'
        db.alter_column('budgetelem_region', 'econokr_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['budgetelem.EconOkr']))

        # Changing field 'Region.fedokr'
        db.alter_column('budgetelem_region', 'fedokr_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['budgetelem.FedOkr']))
