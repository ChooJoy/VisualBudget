...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('budgetelem_region', 'capital')

        # Deleting field 'Document.description'
        db.delete_column('budgetelem_document', 'description')
