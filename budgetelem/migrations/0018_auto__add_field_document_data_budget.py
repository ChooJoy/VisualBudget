...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.data_budget'
        db.add_column('budgetelem_document', 'data_budget',
                      self.gf('django.db.models.fields.DateField')(default='1980-01-01'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.data_budget'
        db.delete_column('budgetelem_document', 'data_budget')
    ...
    models = {
        ...
        'budgetelem.document': {
            ...
            'data_budget': ('django.db.models.fields.DateField', [], {}),
