...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.code_column'
        db.alter_column('budgetelem_document', 'code_column', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.code_column'
        db.alter_column('budgetelem_document', 'code_column', self.gf('django.db.models.fields.IntegerField')(default=0))
