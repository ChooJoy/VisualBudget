...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.local_coords_lat'
        db.add_column('budgetelem_document', 'local_coords_lat',
                      self.gf('django.db.models.fields.CharField')(default=0.0, max_length=10),
                      keep_default=False)

        # Adding field 'Document.local_coords_lng'
        db.add_column('budgetelem_document', 'local_coords_lng',
                      self.gf('django.db.models.fields.CharField')(default=0.0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.local_coords_lat'
        db.delete_column('budgetelem_document', 'local_coords_lat')

        # Deleting field 'Document.local_coords_lng'
        db.delete_column('budgetelem_document', 'local_coords_lng')
