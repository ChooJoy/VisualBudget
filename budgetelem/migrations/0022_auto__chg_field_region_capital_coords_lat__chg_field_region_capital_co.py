...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.capital_coords_lat'
        db.alter_column('budgetelem_region', 'capital_coords_lat', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Changing field 'Region.capital_coords_lng'
        db.alter_column('budgetelem_region', 'capital_coords_lng', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Changing field 'Document.local_coords_lng'
        db.alter_column('budgetelem_document', 'local_coords_lng', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Changing field 'Document.local_coords_lat'
        db.alter_column('budgetelem_document', 'local_coords_lat', self.gf('django.db.models.fields.CharField')(max_length=11))

    def backwards(self, orm):

        # Changing field 'Region.capital_coords_lat'
        db.alter_column('budgetelem_region', 'capital_coords_lat', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Region.capital_coords_lng'
        db.alter_column('budgetelem_region', 'capital_coords_lng', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Document.local_coords_lng'
        db.alter_column('budgetelem_document', 'local_coords_lng', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Document.local_coords_lat'
        db.alter_column('budgetelem_document', 'local_coords_lat', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'budgetelem.document': {
            ...
            'local_coords_lat': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
            'local_coords_lng': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
        ...
        'budgetelem.region': {
            ...
            'capital_coords_lat': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
            'capital_coords_lng': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
