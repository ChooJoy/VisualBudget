...
BubbleTree.Bubbles.Plain = function(node, bubblechart, origin, radius, angle, color) {
	...
	me.init = function() {
		...
		if (!me.node.shortLabel) me.node.shortLabel = me.node.label;
	...
	me.show = function() {
		...
		me.label = $('<div title="'+ me.node.title +'" class="label '+me.node.id+'"><div class="amount">'+utils.formatNumber(me.node.amount)+'</div><div class="desc">'+me.node.shortLabel+'</div></div>');
...
BubbleTree.Bubbles.Donut = function(node, bubblechart, origin, radius, angle, color) {
	...
	this.draw = function() {
        ...
        if ((r < 10)) {me.label2.hide();}
        //alert(me.node.parent.children.length);
	...
	me.show = function() {
        ...
        if (me.node.shortLabel.length > 50) {me.node.shortLabel = me.node.shortLabel.substring(0, 40) + '...';}
        temp_label = '<div class="label '+me.node.id+'"><div class="amount">'+utils.formatNumber(me.node.amount)+'</div><div class="desc">'+me.node.shortLabel+'</div></div>';
		...
		// additional label
        if (me.node.shortLabel.length > 50) {me.node.shortLabel = me.node.shortLabel.substring(0, 40) + '...';}
        temp_label = '<div class="label2 '+me.node.id+'"><span>'+me.node.shortLabel+'</span></div>';
		me.label2 = $(temp_label);
