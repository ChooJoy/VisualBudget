...
function getClientHeight()
{
  return getClientWidth()/2;
	...
	for (i=0; i<data_arr.length;i++) {
		...
		$(obj.node).qtip({ 
                content: { 
                    text: 'Административный центр: <b>' + data_arr[i][3] + '</b><img src="http://choojoy.ru/' + data_arr[i][4] + '" style="float: right;padding:5px;"><br><br>Региональных бюджетов: ' + data_arr[i][5] + '<br>Муниципальных бюджетов: ' + data_arr[i][6], 
                    title: { 
                        text: data_arr[i][1]
                    }
                },		
